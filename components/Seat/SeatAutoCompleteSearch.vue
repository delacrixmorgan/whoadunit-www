...
export default {
  ...
  computed: {
    items() {
      return this.$store.getters['seats/filterSeatsByElectionIdAndSeatType'](
        this.model.electionId,
        this.model.type
      )
    },
  },
  ...
  methods: {
    ...
    setResult(item) {
      ...
      this.collapseSuggestionList()
      this.$emit('select-item', this.model, item)
    },
